...
My name is Sen Yang (杨森 in Chinese). I am interested in various sub-areas at the intersection between natural language processing and machine learning (e.g. information extraction, text generation, representation learning). I can be reached at either [senyang.stu@gmail.com](senyang.stu@gmail.com) or [lusasa0@stu.xjtu.edu.cn](lusasa0@stu.xjtu.edu.cn).
